...
\begin{equation}
	R_T = \expect \left[ \sum_{t=1}^T \gamma^t r_t \Huge{\mid} \pi \right]
\end{equation}
...
We begin with a very brief section on Bayesian optimisation, as we discussed this area in \cite{sec:opteig}.
